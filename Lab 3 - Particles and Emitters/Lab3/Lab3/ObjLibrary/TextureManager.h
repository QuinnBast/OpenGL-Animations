...
//    <1> get returns a refernece to the texture
...
//    <2> !isLoaded(a_name)
//    <2> !isLoaded(name)
//    <3> wrap == GL_REPEAT || wrap == GL_CLAMP
...
//               has wrapping mode wrap in both the S and T
//               directions, magnification filter mag_filter,
//               and minification filter min_fileter.  If a
...
//    <3> mag_filter: The magnification filter
//    <4> min_filter: The minification filter
//    <5> transparent_colour: The transparency colour
...
//               has wrapping mode wrap in both the S and T
//               directions, magnification filter mag_filter,
//               and minification filter min_fileter.  All
