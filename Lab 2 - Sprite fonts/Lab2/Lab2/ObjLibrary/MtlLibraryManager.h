...
//    <2> a_material != NULL
//    <3> logfile != ""
//  Returns: Whether there is a Material with name
//           a_material/material in the MtlLibrary with name
//           a_name/name.
//  Side Effect: If there is no material library loaded with
//	             name a_name/name, and a_name/name ends in
//	             ".mtl" (case-insensitive), a new MtlLibrary
//	             is loaded from a file named a_name/name and
//               error messages may be generated.  If a logfile
...
//               the standard error stream.  If the MtlLibrary
//               has already been loaded, no error messages will
//               be printed.
//
...
//    <2> a_material != NULL
//    <3> logfile != ""
//  Returns: A pointer to the Material with name
//           a_material/material in the MtlLibrary with name
//           a_name/name.  If there is no material named
//           a_material/material in a material library named
//           name a_name/name, NULL is returned.
//  Side Effect: If there is no material library loaded with
//	             name a_name/name, and a_name/name ends in
//	             ".mtl" (case-insensitive), a new MtlLibrary
//	             is loaded from a file named a_name/name and
